...
to(
    f"\033[31;m Script Type>> \033[1;36mSafeUm Vip Account Generetor BILAL BALOCH\n\033[1;31m Script\n\033[31;m Time >>\033[1;33mUnlimited\n\033[31;m")
print('')
print('\033[32;m')
...
def work():
    ...
    username = choice('kcqzy4uejdhcxe1r') + ''.join(choices(list('qwertyuioplkjhgfdsa43fjdjh'), k=13))
    try:
        ...
        con.send(dumps(
            {"action": "Register", "subaction": "Desktop", "locale": "en_GB", "gmt": "+02",
             ...
             "nickname": "hvtctchgfijvfxfx", "os": "AND", "deviceuid": "c72d110c1ae40d50",
        ...
        if '"status":"Success"' in gzip:
            ...
            print(b)
            with open('BILAL-Accounts.txt', 'a') as f:
                f.write(hhhh+ ":hhhh | TG : BILAL\n")
...
while True:
    ...
    if int(success) > int(0):
        ...
        print("Account Generated>> DAVLOpEr : BILAL BALOCH\n", z)
